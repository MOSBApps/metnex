...
const SNAPSHOT = [
    ...
    'POST /reports/:code/analysis/query | analyse | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'POST /reports/:code/analysis/export/:format | exportAnalysis | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:EXPORT',
  'POST /reports/:code/analysis/export/PNG/complete | completePngExport | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:EXPORT',
  'POST /reports/:code/analysis/compare | compare | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'GET /reports/:code/analysis/catalog | catalog | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'GET /reports/:code/analysis/presets | listPresets | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'GET /reports/:code/analysis/presets/:presetId | getPreset | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
  'POST /reports/:code/analysis/presets | create | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'GET /reports/:code/analysis/virtual-columns | list | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'POST /reports/:code/analysis/virtual-columns | create | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'POST /reports/:code/analysis/virtual-columns/:id/activate | activate | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
    'POST /reports/:code/analysis/virtual-columns/:id/disable | disable | class=JwtAuthGuard,MfaEnforcementGuard,TenantHeaderFormatGuard,TenantMembershipGuard,PermissionGuard | method= | perm=REPORT:ARTIFACT:VIEW',
